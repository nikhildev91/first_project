...
! function (b) {
    ...
    o.prototype.createPlotGraph = function (o, a, t, r, e, l, i) {
        ...
        this.createPlotGraph("#website-stats", [
            ...
            [11, 10],
            [12, 8]
        ], ["Google", "Yahoo"], ["#458bc4", "#3db9dc"], "rgba(108, 120, 151, 0.1)", "transparent");
        this.createPlotDotGraph("#website-stats1", [
            ...
            [11, 14],
            [12, 5]
        ], ["Visits", "Page views"], ["#3db9dc", "#d57171"], "rgba(108, 120, 151, 0.1)", "transparent");
        this.createPieGraph("#pie-chart #pie-chart-container", ["Series 1", "Series 2", "Series 3", "Series 4"], [20, 30, 15, 32], ["#458bc4", "#4fc55b", "#3db9dc", "#ebeff2"]);
        var a = this.createRealTimeGraph("#flotRealTime", this.randomData(), ["#23b195"]);
        a.draw();
        var t = this;
        ! function o() {
            a.setData([t.randomData()]), a.draw(), setTimeout(o, (b("html").hasClass("mobile-device"), 500))
        }();
        this.createDonutGraph("#donut-chart #donut-chart-container", ["Series 1", "Series 2", "Series 3", "Series 4"], [35, 20, 10, 20], ["#458bc4", "#4fc55b", "#3db9dc", "#ebeff2"]);
        var o = [
            [
                [0, 201],
                [1, 520],
